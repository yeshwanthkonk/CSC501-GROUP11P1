...
table_etl_meta = {
    ...
    "Posts": dict(source_file="Posts", dest_columns=["id", "created_date", "post_score", "created_by", "post_type_id"], source_columns=["Id_x", "CreationDate", "Score", "OwnerUserId", "PostTypeId"]),
